...
export default class QuizCreator extends React.Component {
    ...
    addQuestionHandler = e => {
        ...
        const questionItem = {
            question: question.value, //instead of this.state.formControls.question.value
            id: index,
    ...
    createQuizHandler = async e => {
        ...
        try {
            await axios.post('https://react-quiz-9c4e1-default-rtdb.firebaseio.com/quizes.json', this.state.quiz)
                ...
                <div>
                    ...
                    <form onSubmit={this.submitHandler}>
                        ...
                        <Button type="success" onClick={this.createQuizHandler}
                                disabled={this.state.quiz.length === 0}>Create test</Button>
                    </form>
                </div>
            </div>
        )
